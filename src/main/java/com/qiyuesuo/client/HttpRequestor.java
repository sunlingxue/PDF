...
public class HttpRequestor {
    ...
    public String doGet(String url) throws Exception {
        ...
        //设置请求头
        httpURLConnection.setRequestProperty("x-qys-open-signature", signature);
        httpURLConnection.setRequestProperty("x-qys-open-accesstoken", token);
        httpURLConnection.setRequestProperty("x-qys-open-timestamp", timestamp);
